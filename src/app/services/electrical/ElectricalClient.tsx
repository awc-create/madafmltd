...
const SERVICES = [
  {
    ...
    description:
      "Complete wiring installations, upgrades, and safety checks for homes and businesses.",
    icon: "mdi:lightning-bolt",
  },
  {
    title: "Panel Upgrades",
    description:
      "Modernize outdated electrical panels to meet today’s safety standards and energy demands.",
    icon: "mdi:breaker",
  },
  {
  ...
  },
  {
    ...
    description:
      "Certified inspections for landlords, businesses, and residential customers.",
    icon: "mdi:clipboard-check-outline",
  },
  {
    title: "Smart Home Setup",
    description:
      "Installation and configuration of smart lighting, sockets, and home automation systems.",
    icon: "mdi:home-automation",
  },
  {
    title: "Network Cabling",
    description:
      "Setup of CAT3, CAT5e, CAT6 network infrastructure for homes and businesses.",
    icon: "mdi:ethernet",
  },
  {
    title: "Fiber Optic (Coming Soon)",
    description:
      "High-speed fiber optic installations for modern homes and offices.",
...
// ✅ Use a typed cubic-bezier tuple (fixes the Variants error you had earlier)
      ...
      <header className={styles.hero} aria-labelledby="electrical-title">
        ...
        >
          ...
          <p className={styles.lead}>
            From full rewires and panel upgrades to smart home automation and 24/7
            emergency call-outs — our accredited electricians deliver safe, reliable
            work for homes, offices and industrial sites.
          </p>
